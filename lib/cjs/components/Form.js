...
// FORM FIELD
// ====================================================================
const FormField = ({ label, name, children, isError, }) => {
    ...
    return (react_1.default.createElement("div", { className: "my-1.5" },
        label && (react_1.default.createElement("label", { htmlFor: name, className: "block mb-1 font-medium text-gray-700" }, label)),
