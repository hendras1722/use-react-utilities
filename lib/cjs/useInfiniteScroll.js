...
function useInfiniteScroll(elementRef, onLoadMore, options = {}) {
    ...
    const scrollStateRef = (0, react_1.useRef)({
        x: 0,
        y: 0,
        isScrolling: false,
        arrivedState: {
    ...
    const loadingPromiseRef = (0, react_1.useRef)(null);
    const isScrollingRef = (0, react_1.useRef)(false);
    const measureScrollState = (0, react_1.useCallback)(() => {
    ...
    const checkAndLoad = (0, react_1.useCallback)(async (force = false) => {
        const element = elementRef.current;
