...
function useDraggable(targetRef, options = {}) {
    ...
    const [position, setPosition] = (0, react_1.useState)(initialPosition); // Gunakan initialPosition
    // State untuk menandakan apakah initialPosition sudah di-set atau belum
    const [isInitialPositionSet, setIsInitialPositionSet] = (0, react_1.useState)(false);
