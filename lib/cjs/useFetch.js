...
function createFetch(config = {}) {
    ...
    return function useFactoryFetch(url, ...args) {
        ...
        const mergedOptions = (0, react_1.useMemo)(() => {
...
function useFetch(url, ...args) {
    ...
    const fetchOptions = (0, react_1.useMemo)(() => parsedRequestInit, [parsedRequestInit]);
    // -------------------------------------------------------------------------
    // Options & Callbacks
    // -------------------------------------------------------------------------
    ...
    // Ref Management
    // -------------------------------------------------------------------------
    const controllerRef = (0, react_1.useRef)(undefined);
    const timerRef = (0, react_1.useRef)(undefined);
    const executeCounterRef = (0, react_1.useRef)(0);
    const hasExecutedRef = (0, react_1.useRef)(false);
    const previousUrlRef = (0, react_1.useRef)(url);
    // Config Ref
    ...
    // Event Hooks
    // -------------------------------------------------------------------------
    const responseEventRef = (0, react_1.useRef)(new EventHook());
    const errorEventRef = (0, react_1.useRef)(new EventHook());
    const finallyEventRef = (0, react_1.useRef)(new EventHook());
    // -------------------------------------------------------------------------
    // Computed Values
    // -------------------------------------------------------------------------
    const canAbort = (0, react_1.useMemo)(() => supportsAbort && isFetching, [supportsAbort, isFetching]);
    // -------------------------------------------------------------------------
    ...
    const loading = (0, react_1.useCallback)((isLoading) => {
    ...
    const waitUntilFinished = (0, react_1.useCallback)(() => {
    ...
    const setMethod = (0, react_1.useCallback)((method) => {
    ...
    const setType = (0, react_1.useCallback)((type) => {
        return () => {
    ...
    // -------------------------------------------------------------------------
    const finalShell = (0, react_1.useMemo)(() => {
        const base = { ...shell };
